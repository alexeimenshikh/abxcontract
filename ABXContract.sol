...
contract ABXContract
{
  ...
  //constructor
  function ABXContract(ABXToken _abx_token)
    public
  {
    owner = msg.sender;
    ...
    initData(0x7E5F4552091A69125d5DfCb7b8C2659029395Bdf, 192998805 * 10**16);
    initData(0x2B5AD5c4795c026514f8317c7a215E218DcCD6cF, 50000 * 10**18);
    initData(0x1efF47bc3a10a45D4B230B5d10E37751FE6AA718, 50000 * 10**18);
    initData(0x252Dae0A4b9d9b80F504F6418acd2d364C0c59cD, 25725 * 10**18);
